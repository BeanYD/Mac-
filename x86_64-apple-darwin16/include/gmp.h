...
#define __GMP_CFLAGS "-Werror=partial-availability -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.13.sdk -mmacosx-version-min=10.10 -DMACOSX_DEPLOYMENT_TARGET=10.10 -m64 -I/Users/jenkins/workspace/vlc-nightly/vlc-nightly-macOS-contrib/contrib/x86_64-apple-darwin16/include -g -O2"
